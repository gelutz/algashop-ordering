...
class PhoneTest {
	...
	void givenNullPhoneShouldThrowNullPointerException() {
		...
		Assertions.assertEquals(ErrorMessages.Validation.PHONE_IS_NULL, exception.getMessage());
	}
	...
	void givenBlankPhoneShouldThrowIllegalArgumentException() {
		...
		Assertions.assertEquals(ErrorMessages.Validation.PHONE_IS_BLANK, exception.getMessage());
	}
}